...
function Expense({ type }) {

    const options = ['recharge', 'groceries', 'fun'];
    ...
    const defaultValue = 'recharge'



    const initVals = { name: 'recharge', price: '', date: new Date().toLocaleDateString() }
